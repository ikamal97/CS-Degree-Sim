...
public class LoseGameMenu extends JPanel implements Observer{
	...
	public LoseGameMenu(csDegreeSim sim, Game game, Character character){
		this.sim = sim;
	...
	public void createComponents() {
		winLabel = new JLabel("You Dropped Out!");
